...
export const addCustomOrder = async () => {
    ...
    await fetch(`https://localhost:7034/orders`, {
        method: "POST",
        headers: {
...
export const getOrders = async () => {
    const res = await fetch("https://localhost:7034/orders")
    const data = await res.json()
    return data
}

export const getWheels = async () => {
    const res = await fetch("https://localhost:7034/wheels")
    const data = await res.json()
    return data
}

export const getInteriors = async() => {
    const res = await fetch("https://localhost:7034/interiors")
    const data = await res.json()
    return data
}

export const getTechnologies = async () => {
    const res = await fetch("https://localhost:7034/technologies")
    const data = await res.json()
    return data
}

export const getPaints = async () => {
    const res = await fetch("https://localhost:7034/paintcolors")
    const data = await res.json()
    return data
}
